...
public class MgwebTestContainer extends TestContainer {

    public MgwebTestContainer() {
        super();
    ...
    public static class Common extends MgwebTestContainer {

        public static final MgwebTestContainer.Common INSTANCE = new MgwebTestContainer.Common();
