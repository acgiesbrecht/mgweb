...
alter table tbl_transferencias add constraint FK_TBL_TRANSFERENCIAS_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_TRANSFERENCIAS_ON_ID_USER on tbl_transferencias (ID_USER)^
alter table tbl_timbrados_notas_de_credito add constraint FK_TBL_TIMBRADOS_NOTAS_DE_CREDITO_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_TIMBRADOS_NOTAS_DE_CREDITO_ON_ID_USER on tbl_timbrados_notas_de_credito (ID_USER)^
alter table tbl_timbrados_compras add constraint FK_TBL_TIMBRADOS_COMPRAS_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_TIMBRADOS_COMPRAS_ON_ID_USER on tbl_timbrados_compras (ID_USER)^
alter table tbl_timbrados_autofacturas add constraint FK_TBL_TIMBRADOS_AUTOFACTURAS_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_TIMBRADOS_AUTOFACTURAS_ON_ID_USER on tbl_timbrados_autofacturas (ID_USER)^
alter table tbl_timbrados add constraint FK_TBL_TIMBRADOS_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_TIMBRADOS_ON_ID_USER on tbl_timbrados (ID_USER)^
alter table tbl_recibos_compra add constraint FK_TBL_RECIBOS_COMPRA_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_RECIBOS_COMPRA_ON_ID_USER on tbl_recibos_compra (ID_USER)^
alter table tbl_recibos add constraint FK_TBL_RECIBOS_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_RECIBOS_ON_ID_USER on tbl_recibos (ID_USER)^
alter table tbl_notas_de_credito_compras add constraint FK_TBL_NOTAS_DE_CREDITO_COMPRAS_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_NOTAS_DE_CREDITO_COMPRAS_ON_ID_USER on tbl_notas_de_credito_compras (ID_USER)^
alter table tbl_notas_de_credito add constraint FK_TBL_NOTAS_DE_CREDITO_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_NOTAS_DE_CREDITO_ON_ID_USER on tbl_notas_de_credito (ID_USER)^
alter table tbl_miembros_relaciones add constraint FK_TBL_MIEMBROS_RELACIONES_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_MIEMBROS_RELACIONES_ON_ID_USER on tbl_miembros_relaciones (ID_USER)^
alter table tbl_facturas_compra add constraint FK_TBL_FACTURAS_COMPRA_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_FACTURAS_COMPRA_ON_ID_USER on tbl_facturas_compra (ID_USER)^
alter table tbl_facturas add constraint FK_TBL_FACTURAS_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_FACTURAS_ON_ID_USER on tbl_facturas (ID_USER)^
alter table tbl_eventos add constraint FK_TBL_EVENTOS_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_EVENTOS_ON_ID_USER on tbl_eventos (ID_USER)^
alter table tbl_evento_detalle add constraint FK_TBL_EVENTO_DETALLE_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_EVENTO_DETALLE_ON_ID_USER on tbl_evento_detalle (ID_USER)^
alter table tbl_evento_cuotas add constraint FK_TBL_EVENTO_CUOTAS_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_EVENTO_CUOTAS_ON_ID_USER on tbl_evento_cuotas (ID_USER)^
alter table tbl_entidades add constraint FK_TBL_ENTIDADES_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_ENTIDADES_ON_ID_USER on tbl_entidades (ID_USER)^
alter table tbl_autofacturas add constraint FK_TBL_AUTOFACTURAS_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
create index IDX_TBL_AUTOFACTURAS_ON_ID_USER on tbl_autofacturas (ID_USER)^
alter table tbl_asientos add constraint FK_TBL_ASIENTOS_ON_ID_USER foreign key (ID_USER) references SEC_USER(ID)^
